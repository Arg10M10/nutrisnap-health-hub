...
import {
  SlidersHorizontal, Languages, Lightbulb, Mail, FileText, Shield, LogOut, Trash2, Loader2, Bell, AlertTriangle, ArrowLeft, HeartPulse, Target, Goal, Palette, Activity
} from "lucide-react";
    ...
    <PageLayout>
      <div className="space-y-8">
        ...
        <SettingsCategory title={t('settings.goals.title')}>
          ...
          <SettingsItem icon={<Activity size={20} />} label={t('settings.goals.connectApps')} onClick={() => navigate('/settings/connect-apps')} />
        </SettingsCategory>
